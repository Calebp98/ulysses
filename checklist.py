...
def generate_response(user_response, rubric_prompt):
    messages = [{"role": "user", "content": f"{user_response}\n\n{rubric_prompt}"}]
...
with col1:
    ...
    if st.button("Generate Responses"):
        rubric_prompts = {
            "Honesty and accuracy": "Respond with response to honesty and accuracy for testing",
...
def rubric_item(title, score, response="LLM response goes here"):
